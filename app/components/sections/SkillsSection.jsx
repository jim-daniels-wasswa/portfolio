...
const SkillsSection = () => {
    const skillGroups = [
        ...
        {
            category: "Frameworks",
            skills: ["Express.js", "Spring MVC", "Flutter", "ASP.NET"],
        ...
        },
        {
            ...
            skills: ["npm", "webpack", "Docker", "Monorepos"],
            gradient: "from-purple-500 to-sky-500",
        },
        {
            category: "Databases",
            skills: ["PostgreSQL", "MSSQL", "MySQL", "MongoDB"],
            gradient: "from-sky-500 to-blue-500",
        },
        {
            category: "Testing",
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {skillGroups.map((group, idx) => (
                        ...
                        >
                            <div
                                className={`inline-block px-4 py-2 bg-gradient-to-r ${group.gradient} text-white font-bold rounded-full mb-4`}
                            >
                                {group.category}
                            </div>

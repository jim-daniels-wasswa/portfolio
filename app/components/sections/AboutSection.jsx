            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="max-w-4xl mx-auto bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-purple-200/50 dark:border-purple-500/20">
                    <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                        ...
                        of experience, specializing in creating scalable,
                        user-focused applications across fintech and healthcare
                        industries.
                    </p>
                    <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
                        ...
                        , and modern web technologies. I love mentoring
                        developers and driving initiatives that improve
                        performance, code quality, and developer productivity.
                    </p>
